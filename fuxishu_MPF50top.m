...
lamda=v1;
tao=(D_q*L*lamda);
f_RF=0e9:0.00075e9:200e9;%所观察的滤波器的频率响应范围,单位Hz，RF射频信号
...
%--------------------------------------------------------------------------------------%
R1=4;
p1a1=R1*(P_cq1*a_cq*a_sq*exp(1i*2*pi*f_RF*(1-1)*tao)*exp(1i*(fai1)));
p1a2=R1*(P_cq2*a_cq*a_sq*exp(1i*2*pi*f_RF*(2-1)*tao)*exp(1i*(fai2)));
p1a3=R1*(P_cq1*a_cq*a_sq*exp(1i*2*pi*f_RF*(3-1)*tao)*exp(1i*(fai3)));
p1a4=R1*(P_cq2*a_cq*a_sq*exp(1i*2*pi*f_RF*(4-1)*tao)*exp(1i*(fai4)));
p1a5=R1*(P_cq1*a_cq*a_sq*exp(1i*2*pi*f_RF*(5-1)*tao)*exp(1i*(fai5)));
p1a6=R1*(P_cq2*a_cq*a_sq*exp(1i*2*pi*f_RF*(6-1)*tao)*exp(1i*(fai6)));
p1a7=R1*(P_cq1*a_cq*a_sq*exp(1i*2*pi*f_RF*(7-1)*tao)*exp(1i*(fai7)));
p1a8=R1*(P_cq2*a_cq*a_sq*exp(1i*2*pi*f_RF*(8-1)*tao)*exp(1i*(fai8)));
p1a9=R1*(P_cq1*a_cq*a_sq*exp(1i*2*pi*f_RF*(9-1)*tao)*exp(1i*(fai9)));
p1a10=R1*(P_cq2*a_cq*a_sq*exp(1i*2*pi*f_RF*(10-1)*tao)*exp(1i*(fai10)));
...
% H_fRF1=p1a1+p1a2+p1a3+p1a4+p1a5+p1a6+p1a7+p1a8+p1a9+p1a10;
% L2_5=20*log10(abs(H_fRF1/100));
%---------------------------------------------绘图部分-----------------------------------------%
% plot(f_RF/(1e9),L2_5,'m','LineWidth',1);
% hold on;
set(0,'defaultfigurecolor','w')

plot(f_RF/(1e9),L2_4,'m','LineWidth',1);
hold on;

axis([0 60 -65 0]);%横纵坐标取值范围
